...
const FilterSection = () => {
  return (
    <div className="w-72 h-[500px] bg-white rounded-3xl">
      <h1 className="text-cool_blue relative top-5 right-7">فیلتر ها</h1>
      ...
      <div className="w-5/6 h-52 text-[#8d8d8d] text-sm border border-[#8d8d8d] rounded-xl m-auto mt-10">
        <div className=" flex flex-row m-4 mt-14">
          <h1>از</h1>
          <input type="text" className="w-14 h-6 outline-none border-b mx-3" />
          <h1> تا </h1>
          <input type="text" className="w-14 h-6 outline-none border-b mx-3" />
          <h1>تومان</h1>
        </div>
