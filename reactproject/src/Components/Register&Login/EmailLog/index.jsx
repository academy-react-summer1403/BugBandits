...
const LoginEmail = () => {
    return (
      ...
      <div dir="rtl" className="w-2/3 h-full pr-12 pt-16">
        <LoginTitle text="حساب کاربری ندارید؟" log="ثبت نام کنید." title="ورود با ایمیل" />
        <div className="mt-5">
          <LogInput placeholder=" ایمیل" />
        </div>
        <div>
          <LogButton text="ادامه" nextroute="/login/recievecodelog" />
        </div>
        <div className="flex flex-row text-xs text-[#8d8d8d] gap-40 pt-1">
          <NavLink to="/login" className="cursor-pointer">ورود با موبایل</NavLink>
