  ...
  return (
    <div>
      {teacher.map((item, index) => (
        <div className={`${darkMode ? "dark" : ""} w-2/5 h-64 bg-white dark:bg-midnight_blue mb-8 m-auto rounded-2xl flex flex-row`}>
          ...
          <div className="w-3/5 h-full pt-4">
            <div className="w-11/12">
              <h1 className="text-cool_blue dark:text-white text-xl">{item.name}</h1>
            ...
            <div className="w-11/12 h-10 mt-5 border-t-2">
              <div
                onClick={() => navigate("/teachers/detail")}
                to="/"
                dir="ltr"
