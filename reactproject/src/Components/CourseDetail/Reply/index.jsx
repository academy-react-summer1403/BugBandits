...
//           ...addedReply,
//           pictureAddress: addedReply.pictureAddress || "/default-avatar.png", // Ensure pictureAddress is always set
//         });
//         setReplyText("");
//         setIsReplyingTo(null);
//       }
...
//               <h1 className="font-iranSans">{reply.author || "Unknown User"}</h1>
//               <h1 className="font-kalamehNum">
//                 {new Date(reply.insertDate).toLocaleDateString("fa-IR")}
//               </h1>
//               <h1 className="font-kalamehNum">
