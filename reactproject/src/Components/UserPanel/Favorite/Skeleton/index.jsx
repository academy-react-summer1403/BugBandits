...
const Skeleton = ({}) => {
  ...
  return (
    <div
      className={`${
        darkMode ? "dark" : ""
      } animate-pulse w-[45%] h-56 bg-white dark:bg-midnight_blue rounded-xl shadow-sm sm:flex  `}
    >
      <div className=" w-64 ">
        <img
        ...
        <div className="p-4 relative flex flex-col h-auto sm:p-7 ">
          ...
          <div className="mt-4 flex flex-row gap-1">
            <Tooltip
              ...
              className="font-iranSans bg-dark_gray dark:bg-blue-200"
            >
              <span className="inline-flex cursor-default items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-800/30 dark:text-blue-500">
                {typeName}
              </span>
            </Tooltip>
            <Tooltip
